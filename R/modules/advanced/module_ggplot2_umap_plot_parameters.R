ggplot2_parameters_umap_UI <- function(id){
  fluidPage(
    fluidRow(
      align = "center",
      # Set x Axis Variable
      column(width = 2, bgc_column_select(id, "x_axis", "Set x axis variable", selected = "UMAP1")),
      # Set y Axis Variable
      column(width = 2, bgc_column_select(id, "y_axis", "Set y axis variable", selected = "UMAP2")),
      # Set fill Variable
