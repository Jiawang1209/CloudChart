ggplot2_violin_Server <- function(id){
  moduleServer(id, function(input, output, session){
    ...
    dot_plot_reac <- eventReactive(input$Plot,{
      ...
      if (input$fill_variable == "") {
          ...
          if (input$add_point == "No") {
            p <- ggplot(df(),
              ...
              geom_violin(
                ...
                linewidth = input$violin_line_width,
                alpha = input$violin_alpha,
                fill = input$fill_variable,
                color = input$violin_border_color
              ) + 
              labs(x = input$x_axis_Title,
                   y = input$y_axis_Title,
                   title = input$plot_title,
        ...
        }else if (input$add_box_plot == "Yes") {
          if (input$add_point == "No") {
            p <- ggplot(df(),
                        aes(x = .data[[input$x_axis]],
                            y = .data[[input$y_axis]])) + 
              ...
              geom_boxplot(
                ...
                linewidth = input$boxplot_line_width,
                alpha = input$boxplot_alpha,
                fill = input$boxplot_fill_color,
                color = input$boxplot_border_color
              ) + 
              labs(x = input$x_axis_Title,
                   y = input$y_axis_Title,
                   title = input$plot_title,
    ...
    bind_plot_outputs(output, input, dot_plot_reac, vals, "Violin_Plot")
