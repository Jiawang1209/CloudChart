ggplot2_parameters_bubble_UI <- function(id){
  fluidPage(
    fluidRow(
      align = "center",
      # Set x Axis Variable
    ...
    fluidRow(
      align = "center",
      #Set Size
      column(width = 2, bgc_column_select(id, "size_variable", "Size variable")),
      column(width = 3, sliderInput(NS(id, "demo_size"), "Size Range", value = c(10, 10), min = 0, max = 40)),
      ...
      column(width = 1, colourInput(NS(id, "color"), "Set shape Color", value = "#000000"))
    ),
