ggplot2_parameters_barplot_UI <- function(id){
  fluidPage(
    fluidRow(
      align = "center",
      # Set x Axis Variable
      ...
      # Set group Variable
      column(width = 2, bgc_column_select(id, "group_variable", "Set group variable")),
      # Set fill Variable
    ...
    fluidRow(
      ...
      column(width = 2, sliderInput(NS(id, "border_width"), "Border Width", value = 0.75, min = 0, max = 2, step = 0.25)),
      column(width = 2, sliderInput(NS(id, "border_size"), "Border Size", value = 0.75, min = 0, max = 2, step = 0.25)),
